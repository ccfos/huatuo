...
//go:generate $BPF_COMPILE $BPF_INCLUDE -s $BPF_DIR/memory_oom_kill.c -o $BPF_DIR/memory_oom_kill.o
...
func init() {
	tracing.RegisterEventTracing("memory_oom_kill", newOOMCollector)
}
