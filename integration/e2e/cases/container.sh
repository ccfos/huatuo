...
source ${ROOT_DIR}/integration/common/utils.sh
source ${ROOT_DIR}/integration/common/huatuo-bamai.sh
source ${ROOT_DIR}/integration/e2e/common/k8s.sh
source ${ROOT_DIR}/integration/e2e/common/kubelet.sh
