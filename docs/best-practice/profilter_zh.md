...
```html
<g class="func_g" title="FileConverter.saveResult (21 samples, 43.75%)">
  <rect x="10.0" y="60" width="350.0" height="16" fill="#e8a33d" rx="2"/>
  <title>FileConverter.saveRect (21 samples, 43.75%)</title>
</g>
<g class="func_g" title="java/io/DataOutputStream.writeUTF (12 samples, 25.00%)">
  <rect x="10.0" y="40" width="200.0" height="16" fill="#76d249" rx="2"/>
</g>
```
...
|  FileConverter.saveResult          | 其他调用路径...                 |
